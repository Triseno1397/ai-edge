...
> This file is mirrored across CLAUDE.md, AGENTS.md, and GEMINI.md so the same instructions load in any
> AI environment. CLAUDE.md is the source of truth; edit it and re-mirror.
